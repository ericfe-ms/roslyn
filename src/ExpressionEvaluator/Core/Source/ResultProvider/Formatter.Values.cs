...
namespace Microsoft.CodeAnalysis.ExpressionEvaluator
{
    ...
    internal abstract partial class Formatter
    {
            ...
            DkmClrCustomTypeInfo customTypeInfo)
        {
            ...
            return IncludeObjectId(
                value,
                string.Format(_defaultFormat, value.EvaluateToString(inspectionContext) ?? inspectionContext.GetTypeName(value.Type, customTypeInfo, FormatSpecifiers: NoFormatSpecifiers)),
                flags);
        }
